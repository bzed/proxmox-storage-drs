...
disagree with each other), the 85 % coverage floor, the branch-and-merge-on-green workflow, and
the domain rules that must not be refactored away. [`.agents/`](.agents/) holds the long form.
